...
```
kubectl apply -f persistentvolumes/specs/caching-proxy-emptydir
...
```
kubectl apply -f persistentvolumes/specs/caching-proxy-pvc/pvc.yaml
```
...
```
kubectl delete -f persistentvolumes/specs/caching-proxy-pvc/
...
```
kubectl apply -f persistentvolumes/specs/caching-proxy-pv
